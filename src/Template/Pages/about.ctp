<section>
    <div class="container">
        ...
        <p class="text-center">Escola, c’est une idée née il y a deux ans dans l'esprit de deux étudiants messins. L’objectif ?
            ...
            compléter sa formation, et ainsi de découvrir, apprendre et progresser.</p>

        <p class="text-center">La méthodologie, les connaissances, les langues, sont autant de domaines que les jeunes,
            motivés et dynamiques professeurs d’Escola se donnent à cœur d’approfondir avec chaque
            élève selon ses besoins.</p>
        ...
        <div class="row">
            <div class="col-md-3 col-md-offset-3">
                <div class="team-member">
                    ...
                    <h3 class="team-member-name">Marwan Brion</h3>
